...
%
CROCO_title  = 'Eastern Pacific Model';
CROCO_config = 'EPAC_north';
%
% Grid dimensions:
%
lonmin =   174;   % Minimum longitude [degree east]
lonmax =   295;   % Maximum longitude [degree east]
latmin = -18;   % Minimum latitudeF  [degree north]
latmax = 22;   % Maximum latitude  [degree north]
%
...
%  Run directory
%
RUN_dir=['/media/maillard/HelloWorld/CROCO/SODA/COUPLED_SIMU/'];
%
%  CROCO input netcdf files directory
%
CROCO_files_dir=['/media/maillard/HelloWorld/CROCO/SODA/COUPLED_SIMU/BRY/'];
...
%-----------------------
%
OGCM        = 'SODA342';        % Select the OGCM: SODA, ECCO
%
OGCM_dir    = [FORC_DATA_DIR];  % OGCM data directory
...
OGCM_prefix = ['soda3.4.2_5dy_ocean_reg_npac12_withBar_'];                                 % generic OGCM file name 
%
